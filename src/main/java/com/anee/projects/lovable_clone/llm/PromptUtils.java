package com.anee.projects.lovable_clone.llm;
...
public class PromptUtils {
    ...
    public static final String CODE_GENERATION_SYSTEM_PROMPT = """
            ...
            **Size Limits (Strict)**
            ...
            - Components: 60 line max -> split into smaller pieces
        ...
        Button
            ...
            **Before Generating Codes**:
            ...
            - ✓ Use daisyUI semantic classs only
            ...
            **Code Quality**:
            ...
            - ✓ Consistent naming (PascalCase components, cameCase functions)
            ...
            8. **Complete implmentations** - No placeholder or TODO comments
